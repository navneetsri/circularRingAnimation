...
public class HoloCircularProgressBar extends View {
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		setProgressColor(attributes.getColor(R.styleable.HoloCircularProgressBar_progress_color, Color.GREEN));
		...
		setWheelSize((int) attributes.getDimension(R.styleable.HoloCircularProgressBar_stroke_width, 80)); // 1507 set the width of circle
		mIsThumbEnabled = attributes.getBoolean(R.styleable.HoloCircularProgressBar_thumb_visible, false); // 1507 to hide the thumb on landing screen
		mIsMarkerEnabled = attributes.getBoolean(R.styleable.HoloCircularProgressBar_marker_visible, false); // 1507 to hide the marker on lading screen
	...
	public void setMarkerProgress(final float progress) {
		mIsMarkerEnabled = false; //1507 to hide the marker from the circle.
